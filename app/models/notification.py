...
class NotificationSetting(Base):
    ...
    discord_guild_id: Mapped[str | None] = mapped_column(String(20), nullable=True)
    discord_guild_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
    discord_channel_name: Mapped[str | None] = mapped_column(String(100), nullable=True)
